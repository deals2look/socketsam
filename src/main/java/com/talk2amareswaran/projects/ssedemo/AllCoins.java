...
public class AllCoins {
	...
	/*public AllCoins(String id, String name, String rank, String price_usd, String price_btc, String volume_usd_24h,
			String symbol, String market_cap_usd, String available_supply, String total_supply, String max_supply,
	...
	public String toString() {
		return "AllCoins [id=" + id + ", name=" + name + ", rank=" + rank + ", price_usd=" + price_usd + ", price_btc="
				+ price_btc + ", volume_usd_24h=" + volume_usd_24h + ", symbol=" + symbol + ", market_cap_usd="
